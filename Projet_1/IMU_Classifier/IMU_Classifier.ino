...
void setup() {
  ...
  Serial.println("Question 1: Jalal est un étudiant en INSTRU 3 ?");
  Serial.println("Question 2: La france a gagné la coupe du monde 2022 ? ");
  Serial.println("Question 3: Les projet sous TinyML  sont-ils intéréssantes ?");
  Serial.println("\n\t\t\t\t ************ REPONSE_QUIZ ************ \n");
